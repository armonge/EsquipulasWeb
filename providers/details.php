...
$query = "
SELECT p.idpersona, p.nombre, p.telefono,p.ruc, p.email, SUM(d.total) as total
FROM personas p
LEFT JOIN personasxdocumento pxd ON pxd.idpersona = p.idpersona
LEFT JOIN documentos d ON d.iddocumento = pxd.iddocumento AND d.idtipodoc = 5
...
<div id="content">
    <h1>Proveedores: <?php echo $row_rsDetails["nombre"] ?></h1>
    <a href="providers/edit.php?id=<?php echo $id ?>">Editar</a>
    <p>
